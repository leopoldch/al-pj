...
class TestPhotoSerializer(unittest.TestCase):
    ...
    def test_givenPhotoInstance_whenSerialize_thenShouldContainExpectedFields(self, mock_album_photo):
    ...
    def test_givenAuthenticatedUserButNoAlbumInContext_whenCreate_thenShouldRaiseValidationError(self):
    ...
    def test_givenAuthenticatedUserAndAlbum_whenCreate_thenShouldCreatePhotoLinkedToAlbum(self, mock_create):
        self.mock_user.is_authenticated = True
    ...
    @patch("core.serializers.photo.Photo.objects.create")
    def test_givenAuthenticatedUserAndAlbum_whenCreate_thenShouldReturnCreatedInstance(self, mock_create):
        self.mock_user.is_authenticated = True
