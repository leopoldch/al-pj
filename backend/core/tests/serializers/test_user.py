...
class TestUserSerializer(unittest.TestCase):
    ...
    def test_givenValidData_whenCreate_thenShouldCallSuperCreate(self, mock_super_create):
    ...
    @patch("rest_framework.serializers.ModelSerializer.create")
    def test_givenValidData_whenCreate_thenShouldReturnCreatedInstance(self, mock_super_create):
